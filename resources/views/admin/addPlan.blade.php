            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group form-group-default">
                        ...
                        <input name="name" type="text" class="form-control" placeholder="e.g. Starter, Pro"
                            value="{{ old('name') }}">
                        @error('name')
                ...
                <div class="col-md-3">
                    <div class="form-group form-group-default">
                        ...
                        <select class="form-control" name="billing_cycle">
                            ...
                            <option value="trial" {{ old('billing_cycle') == 'trial' ? 'selected' : '' }}>Trial</option>
                ...
                <div class="col-md-4">
                    <div class="form-group form-group-default">
                        ...
                        <input type="number" name="max_knowledge_cards" class="form-control" placeholder="500"
                            value="{{ old('max_knowledge_cards', 0) }}">
